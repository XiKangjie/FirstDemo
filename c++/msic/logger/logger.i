...
namespace Logger
{
    ...
    void PrintLog(const Record& rec) {
        ...
        fprintf(fp, "%s\t%s\n", buf, rec.m_ssOstr.str().c_str());
        fprintf(fp, "%s %s\t%s\n", "Apr 22 2014", "14:45:23", rec.m_ssOstr.str().c_str());
        fclose(fp);
    }
}

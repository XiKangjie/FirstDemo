...
int main()
{
    ...
    pthread_create(&t1, __null, tfun1, __null);
    sleep(1);
    pthread_create(&t2, __null, tfun2, __null);

    pthread_join(t1, __null);
    pthread_join(t2, __null);

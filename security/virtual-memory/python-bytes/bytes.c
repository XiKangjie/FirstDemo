...
/**
 * print_python_bytes - prints info about a Python 2 bytes object
 * @p: a pointer to a Python 2 bytes object
 * 
 * Return: Nothing
 *
 * gcc -shared -fPIC -I /usr/include/python2.7 -o libbytes.so bytes.c
 */
void print_python_bytes(PyObject *p)
{
     ...
     if (s && PyBytes_Check(s))
     {
         ...
         of the data it points to */
          ...
          /* ob_size is in PyObject_VAR_HEAD. */
          printf("  size: %ld\n", s->ob_size);

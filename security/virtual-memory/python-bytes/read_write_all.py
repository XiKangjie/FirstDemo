...
Usage: ./read_write_all.py PID search_string replace_by_string
Where:
...
for line in maps_file:
    ...
    print("region size: {}K".format((addr_end - addr_start)/1024))

    # find string
    nb_found = 0;
    try:
        i = region.index(bytes(search_string))
        while (i):
            ...
            mem_file.write(bytes(write_string))
            mem_file.flush()

            # update our buffer
            region.write(bytes(write_string), i)
